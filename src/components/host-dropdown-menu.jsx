    ...
    <div className="relative">
      <DropdownMenu>
        ...
        >
          ...
          <hr/>
          <DropdownMenuItem asChild>
            <Link className='py-2' href="/host/dashboard/listings" target="_blank" rel="noopener noreferrer">
              Host your Property
            </Link>
          </DropdownMenuItem>

          <DropdownMenuItem asChild>
            <Link className='py-2' href="/host/dashboard" target="_blank" rel="noopener noreferrer">
              Manage Experiences
            </Link>
          </DropdownMenuItem>
