...
import {  ChevronDown, Wifi, UtensilsCrossed, Loader2, Wind, Zap, Key, Dog, Home, Building2, HomeIcon as House } from 'lucide-react'
        ...
        <div className="space-y-6 py-6 pb-20">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="property-type">
              <AccordionTrigger className="text-lg font-semibold">Property type</AccordionTrigger>
              <AccordionContent>
                <div className="grid grid-cols-2 gap-4">
                  <Button
                    variant={selectedPropertyTypes.includes('House') ? "default" : "outline"}
                  ...
                  <Button
                    variant={selectedPropertyTypes.includes('Flat') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
                  ...
                  <Button
                    variant={selectedPropertyTypes.includes('Guest house') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
            ...
            <AccordionItem value="amenities">
              ...
              <AccordionContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Button
                    variant={selectedAmenities.includes('Kitchen') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
                  ...
                  <Button
                    variant={selectedAmenities.includes('Washing machine') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
                  ...
                  <Button
                    variant={selectedAmenities.includes('Air conditioning') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="booking-options">
              <AccordionTrigger className="text-lg font-semibold">Booking options</AccordionTrigger>
              <AccordionContent>
                <div className="grid grid-cols-2 gap-4">
                  <Button
                    variant={selectedBookingOptions.includes('Instant Book') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
                  ...
                  <Button
                    variant={selectedBookingOptions.includes('Self check-in') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
                  ...
                  <Button
                    variant={selectedBookingOptions.includes('Allows pets') ? "default" : "outline"}
                    className="h-24 flex flex-col items-start p-4"
