...
import FilterSheet from '@/components/experiences/filter-sheet'
...
export default function ExperienceSection() {
  ...
  const displayedExperiences = showAll ? experiences : experiences.slice(0, 8);
    ...
    return(
<section>
   <Heading text="Sail into Serenity : Your Ultimate Cruise Adventure"/>
    <SubHeading className="text-left" text="Unwind, Indulge, and Create Memories on the Open Sea"/>
