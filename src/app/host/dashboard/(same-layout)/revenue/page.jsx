...
const bookings = [
//   { id: 1, property: "Sunset View", guest: "John Doe", checkIn: "2023-06-15", checkOut: "2023-06-20", amount: 1500, status: "Completed" },
//   { id: 2, property: "Palm Grove", guest: "Jane Smith", checkIn: "2023-06-18", checkOut: "2023-06-22", amount: 800, status: "Upcoming" },
//   { id: 3, property: "Ocean Breeze", guest: "Mike Johnson", checkIn: "2023-06-10", checkOut: "2023-06-13", amount: 600, status: "Completed" },
//   { id: 4, property: "Mountain Mist", guest: "Sarah Brown", checkIn: "2023-06-25", checkOut: "2023-06-30", amount: 1200, status: "Upcoming" },
//   { id: 5, property: "City Lights", guest: "Chris Wilson", checkIn: "2023-06-05", checkOut: "2023-06-08", amount: 750, status: "Completed" },
]
...
const RevenuePage = () => {
  ...
  return (
    <div className="container mx-auto space-y-6">
      ...
      <h1 className="text-2xl font-semibold font-bricolage text-absoluteDark mb-2">Revenue Insights</h1>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Highest Daily Revenue</CardTitle>
            <TrendingUp className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">₹{0}</div>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={revenueData[timePeriod]}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="revenue" fill="#2ecc71" /> {/* Updated to use a shade of green */}
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
