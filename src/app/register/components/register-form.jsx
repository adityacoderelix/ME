...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://server-me.vercel.app/api/v1';
...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-white ">
      ...
      <form onSubmit={handleSubmit} className="p-6 md:p-8 max-w-2xl flex border border-gray-100 flex-col justify-center items-start  mx-auto w-full bg-gray-50 rounded-lg shadow-sm">
        <div className="mb-8">
          ...
          {step === 1 && (
            <p className="text-stone text-sm">
              ...
              <Link href="/login" className="text-absoluteDark underline hover:text-gray-700 transition-colors">
                Sign in
              </Link>
            </p>
          )}
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.firstName && 
                    <p className="text-red-500 text-sm mt-1" role="alert">{errors.firstName}</p>
                  }
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.lastName && 
                    <p className="text-red-500 text-sm mt-1" role="alert">{errors.lastName}</p>
                  }
                </div>
              </div>
              <small className="text-stone text-xs  ">Make sure this matches the name on your government ID</small>
              ...
              <div>
                ...
                />
                {errors.dob && 
                  <p className="text-red-500 text-sm mt-1" role="alert">{errors.dob}</p>
                }
                <small className="text-stone text-xs mt-1">You must be 18 or older to use Majestic Escape. Your birthday remains private</small>
              </div>
...
<div className="flex md:gap-x-6 flex-col md:flex md:flex-row ">
              ...
              <div>
                ...
                {errors.phoneNumber && 
                  <p className="text-red-500 text-sm mt-1" role="alert">{errors.phoneNumber}</p>
                }
              </div>
              </div>
              <small className="text-stone text-xs">We use phone and email to send notifications, updates, confirmations and OTPs.</small>
              </div>
              <Button 
                type="submit"
          ...
          <div className="text-center text-sm text-gray-600">
            <p>
              ...
              <Link href="/terms-of-service" className="text-absoluteDark underline hover:text-gray-700">
                Terms of Service
              </Link>
              {' and '}
              <Link href="/privacy-policy" className="text-absoluteDark underline hover:text-gray-700">
                Privacy Policy
              </Link>
            </p>
          </div>
