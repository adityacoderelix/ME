...
interface BookingWidgetProps {
  ...
  onGuestChange: (type: "adults" | "children" | "infants" | "pets", value: number) => void
  toggleCalendar: () => void
      ...
      <CardContent className="p-0">
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              <span className="text-2xl font-semibold font-bricolage">₹{pricePerNight.toLocaleString()}</span>
          ...
          <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
            <div className="border border-gray-300 rounded-lg mb-4">
              <div className="grid grid-cols-2 divide-x divide-gray-300">
                <PopoverTrigger asChild>
                  <div className="p-3 cursor-pointer hover:bg-gray-50 transition-colors rounded-tl-lg">
                    ...
                    <div className="mt-1 text-base">{date?.from ? formatDate(date.from) : "Add date"}</div>
                  </div>
                </PopoverTrigger>
                <PopoverTrigger asChild>
                  <div className="p-3 cursor-pointer hover:bg-gray-50 transition-colors rounded-tr-lg">
                    ...
                    <div className="mt-1 text-base">{date?.to ? formatDate(date.to) : "Add date"}</div>
                  </div>
                </PopoverTrigger>
              </div>
              ...
              >
                ...
                <div>{showGuestsDropdown ? <ChevronUp size={18} /> : <ChevronDown size={18} />}</div>
              </div>
            </div>
            ...
            <PopoverContent className="w-auto p-0" align="start">
              <div className="p-4 border-b">
                ...
                <div className="text-sm text-gray-600 mt-1">Add your travel dates for exact pricing</div>
              </div>
              <div className="p-4">
                <Calendar
                  mode="range"
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      size="icon"
                      className="h-8 w-8 rounded-full"
                      onClick={() => onGuestChange("children", guests.children - 1)}
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      size="icon"
                      className="h-8 w-8 rounded-full"
                      onClick={() => onGuestChange("infants", guests.infants - 1)}
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Bringing a service animal?</div>
                  </div>
                  <div className="flex items-center gap-2">
                    <Button
                      variant="outline"
                ...
                <div className="flex justify-end">
                  <Button variant="default" className="bg-primaryGreen hover:brightGreen" onClick={toggleGuestsDropdown}>
                    Close
                  </Button>
                </div>
              </div>
          ...
          {date?.from && date?.to && (
            <>
              <div className="text-center text-sm text-gray-600 mt-2">You won't be charged yet</div>

              <div className="mt-4 space-y-2">
                <div className="flex justify-between">
                  <div className="underline text-sm">
                    ₹{pricePerNight.toLocaleString()} x {nightsCount} night{nightsCount !== 1 ? "s" : ""}
                  </div>
                ...
                <div className="flex justify-between">
                  ...
                  <div className="text-sm">₹{calculateServicFee((pricePerNight*nightsCount))}</div>
                </div>

                <div className="flex justify-between pt-4 border-t ">
                  <div>Total before taxes</div>
                  <div>₹{calculatePriceWithoutTax(pricePerNight*nightsCount)}</div>
                </div>
              </div>
            </>
          )}
